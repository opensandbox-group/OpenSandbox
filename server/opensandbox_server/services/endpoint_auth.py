...
def build_execd_access_headers(token: str) -> dict[str, str]:
    """Build the header execd itself checks (runtimes where execd, not a gateway, enforces access)."""
    return {EXECD_ACCESS_TOKEN_HEADER: token}
