...
is_generated_to_skip() {
  ...
  # Files emitted by code generators (e.g. bpf2go) carry the standard Go
  # marker; regeneration would clobber any manually added header.
  if head -n 25 "$file" 2>/dev/null | grep -q "Code generated by .* DO NOT EDIT"; then
    return 0
  fi
  return 1
}
